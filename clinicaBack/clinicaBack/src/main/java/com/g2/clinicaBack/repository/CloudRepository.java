...
public class CloudRepository {
    ...
    private final String BUCKET = ""; // Reemplaza con el nombre correcto de tu cubo
    private final String ACCESS_KEY = ""; // Reemplaza con tu clave de acceso
    private final String SECRET_KEY = ""; // Reemplaza con tu clave secreta
